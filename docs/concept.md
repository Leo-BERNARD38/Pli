...
|---|---|---|
| `pli.re/` | elle | Les plis reçus, et le journal |
| `pli.re/atelier/` | moi | Déposer un pli, fabriquer le lien |
...
l'encode, je pousse. Le lien ne porte que son numéro : `pli.re/#p=015-vhtq`. C'est ce qui
