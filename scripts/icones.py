...
MANIFESTE = """{
  ...
  "theme_color": "#C81E33",
  "icons": [
    { "src": "/icones/favicon.svg", "type": "image/svg+xml", "sizes": "any" },
    { "src": "/icones/icon-192.png", "type": "image/png", "sizes": "192x192" },
    { "src": "/icones/icon-512.png", "type": "image/png", "sizes": "512x512" },
    { "src": "/icones/icon-512-masque.png", "type": "image/png", "sizes": "512x512",
      "purpose": "maskable" }
  ]
}
"""
